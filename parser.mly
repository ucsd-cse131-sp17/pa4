...
%token <int> NUM
%token <string> ID
%token END LBRACK RBRACK DEF ADD1 SUB1 LPAREN RPAREN LET IN EQUAL COMMA PLUS MINUS TIMES IF COLON ELSECOLON TRUE FALSE ISBOOL ISNUM ISTUPLE INPUT EQEQ LESS GREATER PRINT EOF
